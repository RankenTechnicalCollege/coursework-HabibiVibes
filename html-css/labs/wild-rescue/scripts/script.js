...
function ans1() {
    ...
    answer.textContent = "Step back and observe the situation for a few minutes. Wait to see if the parent arrives. if the animal is in immediate danger from a predator or is in the road, remove the baby and bring it to a rescue center.";
}
...
function ans3() {
    heading.style.display = "block";
    answer.textContent = "No. This is a myth. The parents will retrieve the baby bird and place it back in the nest. If the parents do not return, contact us.";
}
