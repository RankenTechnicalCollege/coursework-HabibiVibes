...
// declare htmlCode variable setting values to an empty string
let htmlCode = "";

// loop to generate html code for each movie
...
// write the htmlCode string to the tableBody element
