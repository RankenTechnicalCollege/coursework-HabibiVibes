...
document.getElementById("deal").onclick = function() {   
      ...
      for (let i = 0; i < cards.length; i++) {
            ...
            // if the deck is empty, call newDeck ( ) function
            if (deck.length === 0) {
                  newDeck();
            }

            // pop ( ) method to remove and return the last card from the deck array
            let nextCard = deck.pop();
            cards[i].textContent = nextCard;

            // update cardsLeft text content
